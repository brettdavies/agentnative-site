...
The site accepts three shapes of contribution. All three are welcome; none is required. Site work skews toward Tier 3
...
the spec repo's [`grade-a-cli`](https://github.com/brettdavies/agentnative/issues/new?template=grade-a-cli.yml)
template, not a PR here. The site renders what the registry contains; the registry lives in the CLI repo.
...
advisories channel. The Sandbox container, the Worker, and the R2 cache are the primary surfaces of concern.
