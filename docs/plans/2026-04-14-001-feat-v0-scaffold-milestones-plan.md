...
- `tsconfig.json`
- `wrangler.jsonc` (shape from build plan §Distribution; `account_id: 6c1bafea907fecbd4ad665b8d0a78e53`)
- `biome.json`
- `.editorconfig`
...
- `CF_ACCOUNT_ID` added as repo secret (`6c1bafea907fecbd4ad665b8d0a78e53`).
