...
// ---------------------------------------------------------------------------
// Vary matrix. Extensionless /api/score negotiates JSON vs markdown by
// Accept alone (detectScorePreference never reads User-Agent), so it
// carries `Vary: Accept` on every freshness class; the suffix-pinned
// twins are one representation each and carry none.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Suffix-dispatch drift canary. preferenceFor must agree with the shared
// pinned-representation predicate: pinned paths ignore Accept (the suffix
// decides), the extensionless path honors it.
// ---------------------------------------------------------------------------
