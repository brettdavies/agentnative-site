...
Measured by check IDs `p1-non-interactive` (behavioral) and `p1-non-interactive-source` (source). Run `agentnative
check --principle 1 .` against your CLI to see both.
