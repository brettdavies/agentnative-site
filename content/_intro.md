...
makes that loop tractable or it does not. The same holds for the websites and MCP servers agents reach over HTTP: they
either expose a machine-readable, discoverable surface or they force the agent to scrape blind. This site measures
agent-readiness on both surfaces, CLI and web, against one set of eight principles.
