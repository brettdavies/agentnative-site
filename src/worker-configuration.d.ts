/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 9c10c48454b81d54b46e7f0d9bece5b8)
// Runtime types generated with workerd@1.20260405.1 2026-04-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		WEB_RESCORE_WORKFLOW: Workflow<Parameters<import("./worker/index").WebRescoreWorkflow['run']>[0]['payload']>;
	}
	interface Env {
		SCORE_KV: KVNamespace;
		SCORE_CACHE: R2Bucket;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_SITEKEY" | "MCP_CACHE_BYPASS_ALLOWED" | "WEB_AUDIT_ENABLED" | "TURNSTILE_SECRET" | "SESSION_HMAC_SECRET" | "MCP_ENABLED" | "MCP_LIVE_SCORING_ENABLED">> {}
}
