...
export function markdownAlternateLink(markdownPath: string): string {
  return `<link rel="alternate" type="text/markdown" href="${escHtml(markdownPath)}" title="This page as markdown" />`;
}
...
export function jsonAlternateLink(jsonPath: string): string {
  return `<link rel="alternate" type="application/json" href="${escHtml(jsonPath)}" title="This result as JSON" />`;
}
